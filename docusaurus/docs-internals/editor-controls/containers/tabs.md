...
| `config?.horizontalScroll` | `boolean`                                 |  `false`   | Specifies when tabs should remain on a single row and be horizontally scrollable                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
...
#### Config `horizontalScroll` example

When `horizontalScroll` is set to `true`, tabs will not wrap onto a new row. Instead, all tabs will remain on a single row, and any tabs that overflow the container will become horizontally scrollable. In this case, left and right scroll icons are added. Currently, `horizontalScroll` is supported only when the `tabs` control is used inside a sidebar.
