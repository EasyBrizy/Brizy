...
> You need to add the API configuration handler (`api.media.addMediaGallery.handler`) for these option types to work fully. For more details, refer to the **[documentation](/api-reference#example-media-gallery-handler)**.
