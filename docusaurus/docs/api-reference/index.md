...
| `ui.features.typography.shouldSortFonts` | `boolean` | Controls how fonts are ordered in the **typography** control’s font family dropdown. When `true` (the default if omitted), fonts are sorted alphabetically by display name. When `false`, fonts keep the order they are defined in your fonts configuration (Google, upload, Adobe, system, etc.).                                                                                                                                                                                                                                                                                                                              |
